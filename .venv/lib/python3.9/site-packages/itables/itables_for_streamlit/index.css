...
:host[data-theme=dark] table.dataTable td.dt-control:before {
...
:host[data-theme=dark] table.dataTable tr.dt-hasChild td.dt-control:before {
...
div.dt-container .dt-paging .dt-paging-button.current:hover {
  ...
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(229.5, 229.5, 229.5, .05)), color-stop(100%, rgba(0, 0, 0, .05)));
  background: -webkit-linear-gradient(top, rgba(229.5, 229.5, 229.5, .05) 0%, rgba(0, 0, 0, .05) 100%);
  background: -moz-linear-gradient(top, rgba(229.5, 229.5, 229.5, .05) 0%, rgba(0, 0, 0, .05) 100%);
  background: -ms-linear-gradient(top, rgba(229.5, 229.5, 229.5, .05) 0%, rgba(0, 0, 0, .05) 100%);
  background: -o-linear-gradient(top, rgba(229.5, 229.5, 229.5, .05) 0%, rgba(0, 0, 0, .05) 100%);
  background:
    linear-gradient(
      to bottom,
      #e6e6e60d,
...
div.dt-button-info {
  ...
  border-radius: .75em;
  box-shadow: 3px 4px 10px 1px #000c;
  text-align: center;
  z-index: 2003;
  overflow: hidden;
}
...
:host {
  ...
  --dtcc-button_opacity: .4;
  --dtcc-button_padding: 3px;
  --dtcc-button_disabled-opacity: .6;
  --dtcc-button_empty-opacity: .8;
  --dtcc-button_hover-border: none;
  --dtcc-button_hover-background: rgba(0, 0, 0, .1);
  --dtcc-button_hover-opacity: .9;
  --dtcc-button-icon_color: black;
  --dtcc-button-icon_size: 16px;
  --dtcc-button-icon_margin: .5em;
  --dtcc-dropdown_background: white;
  --dtcc-dropdown_border: 1px solid rgba(0, 0, 0, .2);
  --dtcc-dropdown_border-radius: 5px;
  --dtcc-dropdown_box-shadow: 3px 4px 10px 1px rgba(0, 0, 0, .3);
  --dtcc-dropdown_margin: 3px 0 0 0;
  --dtcc-dropdown_padding: .75em 0;
  ...
  --dtcc-dropdown-button_padding: .5em 1em;
  --dtcc-dropdown-button_hover-background: rgba(0, 0, 0, .05);
  --dtcc-dropdown-icon_vertical-align: initial;
  --dtcc-dropdown-search_padding: .5em 1em;
  --dtcc-spacer_border: 1px solid rgba(0, 0, 0, .2);
  --dtcc-spacer_margin: .5em;
  --dtcc-title_background: rgba(255, 255, 255, .1);
  --dtcc-title_border-left: none;
  --dtcc-title_border-right: none;
  --dtcc-title_border-top: none;
  --dtcc-title_border-bottom: ;
  --dtcc-title_margin: 0;
  --dtcc-title_padding: .5em 0;
  --dtcc-title_text-align: center;
  --dtcc-search-icon_color: black;
  --dtcc-search-icon_hover-background: rgba(0, 0, 0, .1);
  --dtcc-search-icon_opacity: .4;
  --dtcc-search-icon_size: 16px;
  --dtcc-search-clear_right: 8px;
  --dtcc-search-clear_bottom: 2px;
  --dtcc-search-input_margin-top: .5em;
  ...
  --dtcc-list-buttons_background: rgba(0, 0, 0, .05);
}
:root.dark,
:host.dark {
  --dtcc-button_hover-background: rgba(255, 255, 255, .1);
  --dtcc-button-icon_color: white;
  --dtcc-spacer_border: 1px solid rgba(255, 255, 255, .15);
  --dtcc-dropdown_background: rgb(33, 37, 41);
  --dtcc-dropdown_border: 1px solid rgba(255, 255, 255, .15);
  --dtcc-dropdown_box-shadow: 3px 4px 10px 1px rgba(0, 0, 0, .8);
  --dtcc-dropdown-button_color: white;
  --dtcc-dropdown-button_hover-background: rgba(153, 153, 153, .1);
  --dtcc-search-icon_color: white;
  --dtcc-search-icon_hover-background: rgba(255, 255, 255, .1);
  --dtcc-search-input_border: 1px solid rgba(255, 255, 255, .2);
  --dtcc-list-buttons_background: rgba(255, 255, 255, .05);
}
...
:host {
  ...
  --dt-datetime-buttons-link_padding: 0 .5em .5em .5em;
  --dt-datetime-buttons-link_font-size: .9em;
  --dt-datetime-table-header_font-size: .8em;
  --dt-datetime-table-header_color: #777;
  --dt-datetime-table-header_padding: 0 0 4px 0;
  --dt-datetime-table-body_font-size: .9em;
...
:host[data-bs-theme=dark] {
  ...
  --dt-datetime_box-shadow: 3px 4px 10px 1px rgba(0, 0, 0, .8);
  ...
  --dt-datetime-label_hover-background: rgba(255, 255, 255, .1);
  --dt-datetime-icon_border: 1px solid transparent;
  --dt-datetime-icon_hover-border: 1px solid transparent;
  --dt-datetime-icon_hover-background: rgba(255, 255, 255, .1);
...
:host[data-theme=dark] input.dt-datetime,
:root[data-theme=dark] select,
:host[data-theme=dark] select,
:root[data-bs-theme=dark] input.dt-datetime,
:host[data-bs-theme=dark] input.dt-datetime,
:root[data-bs-theme=dark] select,
:host[data-bs-theme=dark] select {
  color-scheme: dark;
}
html.dark.inline,
:root[data-theme=dark].inline,
:host[data-theme=dark].inline,
:root[data-bs-theme=dark].inline,
:host[data-bs-theme=dark].inline {
  box-shadow: none;
  border: none;
}
div.dt-button-collection {
